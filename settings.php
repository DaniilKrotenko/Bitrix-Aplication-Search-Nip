<?php
define('C_REST_CLIENT_ID','local.655c9030bf18d9.09910874');//Application ID
define('C_REST_CLIENT_SECRET','igDOAskQtB1re5CMpv7d5C3fAR1qoSVafRRHoMOw7CrQxWnehe');//Application key
// or
